...
https://message-admin.now.sh/

Это приложение тестирует GraphQL API, используемый для рассылки уведомлений RGRU.
...
Это одностраничное веб приложение. Все файлы в директории `public/`.
Для запуска можно использовать любой веб сервер.